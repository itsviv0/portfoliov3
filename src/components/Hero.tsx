  ...
  return (
    ...
    >
          ...
          >
            <div className="typewriter-container">
              <span className="typewriter-text">
                I build scalable applications, craft seamless UIs, and engineer intelligent data pipelines.
              </span>
      ...
      <div className="absolute bottom-12 left-1/2 transform -translate-x-1/2 animate-bounce">
        <a href="#about" className="block text-teal hover:text-white transition-colors">
          <ChevronDown size={32} />
        </a>
      </div>
